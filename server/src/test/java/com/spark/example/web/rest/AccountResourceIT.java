package com.spark.example.web.rest;

import com.spark.example.ServerApp;
import com.spark.example.config.Constants;
import com.spark.example.domain.User;
import com.spark.example.repository.AuthorityRepository;
import com.spark.example.repository.UserRepository;
import com.spark.example.security.AuthoritiesConstants;
import com.spark.example.service.UserService;
import com.spark.example.service.dto.PasswordChangeDTO;
import com.spark.example.service.dto.UserDTO;
import com.spark.example.web.rest.vm.KeyAndPasswordVM;
import com.spark.example.web.rest.vm.ManagedUserVM;
...
import static com.spark.example.web.rest.AccountResourceIT.TEST_USER_LOGIN;
